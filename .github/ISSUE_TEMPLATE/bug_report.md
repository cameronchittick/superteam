...
## Is this a Superteam issue or a platform issue?
<!-- Superteam is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superteam installed.

     If the problem persists without Superteam, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superteam installed
