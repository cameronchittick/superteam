...
**Spec:** `docs/superteam/specs/2026-08-05-hermes-version-bump-wiring-design.md`
...
make_fixture "$happy_repo" $'name: superteam\nversion: 1.2.3'
...
make_fixture "$invalid_repo" $'name: superteam\nversion: 123'
