...
> **For agentic workers:** REQUIRED: Use superteam:subagent-driven-development (if subagents available) or superteam:executing-plans to implement this plan.
...
**Spec:** docs/superteam/specs/2026-01-22-document-review-system-design.md
...
```markdown
> **For agentic workers:** REQUIRED: Use superteam:subagent-driven-development (if subagents available) or superteam:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
