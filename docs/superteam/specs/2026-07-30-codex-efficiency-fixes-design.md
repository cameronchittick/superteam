...
- Eval campaign closeout: `superteam-autoresearch/reports/2026-07-codex-efficiency-campaign.md`
  (treatment table §4; every treatment below has a scorer and a measured
  `dev` baseline).
- Codex source recon: `superteam-autoresearch/docs/2026-07-29-codex-multiagent-v2-capabilities.md`
  (file:line citations against the Codex CLI source; grounds T2, T3, T5).
- Published experiment write-ups: `superteam-evals/docs/experiments/`.
...
campaign as superteam skill/doc changes, each graded against its
...
**Changes** (`skills/using-superteam/references/codex-tools.md`):
...
`skills/using-superteam/references/codex-tools.md` to be
...
- **Pre-registration:** every battery gets a hypothesis-log entry
  ...
  `superteam-autoresearch/logs/2026-07-30-codex-efficiency-fixes.md`
...
- Scenario/rig changes (un-gating ceremony scenarios for Claude
  Code/Gemini, adversarial micro briefs) land in `superteam-evals`
  main, as authorized.
