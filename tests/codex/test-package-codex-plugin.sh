...
if [[ -x "$extracted/skills/team-driven-development/scripts/task-brief" ]]; then
...
tar_task_brief_mode="$(tar -tzvf "$tar_archive" skills/team-driven-development/scripts/task-brief | awk '{print $1}')"
