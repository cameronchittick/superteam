...
# Test: superteam-driven-development, please
echo ">>> Test 1: superteam-driven-development-please"
if "$SCRIPT_DIR/run-test.sh" "superteam-driven-development" "$PROMPTS_DIR/superteam-driven-development-please.txt"; then
    PASSED=$((PASSED + 1))
    RESULTS="$RESULTS\nPASS: superteam-driven-development-please"
else
    FAILED=$((FAILED + 1))
    RESULTS="$RESULTS\nFAIL: superteam-driven-development-please"
fi
echo ""
...
if "$SCRIPT_DIR/run-test.sh" "superteam-driven-development" "$PROMPTS_DIR/mid-conversation-execute-plan.txt"; then
    PASSED=$((PASSED + 1))
