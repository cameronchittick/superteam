#!/usr/bin/env bash
# Regression check: Superteam should not route new worktrees through the old
...
ROTOTILL_SPEC="$REPO_ROOT/docs/superteam/specs/2026-04-06-worktree-rototill-design.md"
ROTOTILL_PLAN="$REPO_ROOT/docs/superteam/plans/2026-04-06-worktree-rototill.md"
...
assert_not_contains "$USING_SKILL" "~/.config/superteam/worktrees" "using-git-worktrees does not mention old global path"
...
assert_not_contains "$FINISHING_SKILL" "~/.config/superteam/worktrees" "finishing-a-development-branch does not treat old global path as owned"
...
assert_not_contains "$ROTOTILL_SPEC" "~/.config/superteam/worktrees" "rototill spec does not preserve old global path policy"
assert_not_contains "$ROTOTILL_PLAN" "~/.config/superteam/worktrees" "rototill plan does not preserve old global path policy"
