...
I want you to execute the implementation plan at docs/superteam/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superteam/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superteam:subagent-driven-development"' "$SESSION_FILE"; then
