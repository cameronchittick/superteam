...
This is a minimal plan to test the team-driven-development workflow.
...
I want you to execute the implementation plan at docs/superteam/plans/implementation-plan.md using the team-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superteam/plans/implementation-plan.md using the team-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superteam:team-driven-development"' "$SESSION_FILE"; then
    echo "  [PASS] team-driven-development skill was invoked"
else
