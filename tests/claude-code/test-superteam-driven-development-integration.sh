#!/usr/bin/env bash
# Integration Test: superteam-driven-development workflow
...
echo "========================================"
echo " Integration Test: superteam-driven-development"
echo "========================================"
echo ""
...
mkdir -p src test docs/superteam/plans

# Create a simple implementation plan
cat > docs/superteam/plans/implementation-plan.md <<'EOF'
# Test Implementation Plan

This is a minimal plan to test the superteam-driven-development workflow.
...
# Run Claude with superteam-driven-development
# Capture full output to analyze
OUTPUT_FILE="$TEST_PROJECT/claude-output.txt"

# Create prompt file
cat > "$TEST_PROJECT/prompt.txt" <<'EOF'
I want you to execute the implementation plan at docs/superteam/plans/implementation-plan.md using the superteam-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superteam/plans/implementation-plan.md using the superteam-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superteam:superteam-driven-development"' "$SESSION_FILE"; then
    echo "  [PASS] superteam-driven-development skill was invoked"
else
...
if [ $FAILED -eq 0 ]; then
    ...
    echo ""
    echo "The superteam-driven-development skill correctly:"
