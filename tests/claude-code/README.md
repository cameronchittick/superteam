...
Automated tests for superteam skills using Claude Code CLI.
...
- Local superteam plugin installed (see main README for installation)
...
### Run specific test:
```bash
./run-skill-tests.sh --test test-superteam-driven-development.sh
```
...
- Executes plan using superteam-driven-development
...
```bash
./run-skill-tests.sh --verbose --test test-superteam-driven-development.sh
```
