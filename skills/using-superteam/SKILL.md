...
- "Let's build X" → superteam:brainstorming first, then implementation skills.
- "Fix this bug" → superteam:systematic-debugging first, then domain skills.
