...
- When the design touches module boundaries, use superteam:codebase-design vocabulary (module, interface, seam, adapter, depth, leverage, locality) and offer its design-it-twice pass for the chosen interface — Architectural path only
