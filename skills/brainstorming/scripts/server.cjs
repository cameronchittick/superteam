...
.brand-copy { display: block; min-width: 0; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; line-height: 1; }
</style>
</head>
...
function brandMarkup() {
  ...
  return '<div class="brand"><span class="brand-copy">Superteam v' + version + '</span></div>';
}
