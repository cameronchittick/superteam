...
4. **team-driven-development** or **executing-plans** - Activates with plan. Dispatches one implementer IC per task, in its own worktree, with two-stage review (spec compliance, then code quality), or executes in batches with human checkpoints.
...
- **team-driven-development** (formerly subagent-driven-development) - Fast iteration with two-stage review (spec compliance, then code quality)
